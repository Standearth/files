...
// default donate url
 ...
 // behaviour that overrides the default redirect
  ...
  function donate_redirect(monthly) {
    if (monthly) {
      if (country == 'Canada') {
        location.href = 'https://act.stand.earth/page/80282/donate/1?chain&xvar=scroll&transaction.paycurrency=CAD&supporter.appealCode='+pageJson.campaignPageId;
      } else {
        location.href = 'https://act.stand.earth/page/80315/donate/1?chain&xvar=scroll&transaction.paycurrency=USD&supporter.appealCode='+pageJson.campaignPageId;
      }
    } else {
      console.log('onetime');
      if (country == 'Canada') {
